...
function getCard()
       local keycard = workspace:FindFirstChild("DropCardModel", true)

            if keycard then
               local part = keycard:FindFirstChildWhichIsA("BasePart")
...
Tabcool:CreateButton({
	Name = "get keycard",
	Callback = function ()
		getCard() -- by https://scriptblox.com/u/Dogpounded 
	end,
})
Tabcool:CreateButton({
	Name = "esp",
